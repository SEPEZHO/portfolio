                                        ...
                                        con.query(
                                                ...
                                                (erro, results) => {
                                                        ...
                                                        let requestBegin = https.request(optionsHttp, resBegin => {
                                                                ...
                                                                resBegin.on("end", () => {
                                                                        console.log(JSON.parse(bodyBegin))
                                                                        let commiterDate = JSON.parse(bodyBegin).commit.committer.date;
...
const sendReqBaseApi = new Promise(() => {
        console.log('a')
        const optionsHttps = {
                host: "api.github.com",
...
sendReqBaseApi.then(sendReqLastCommit())
