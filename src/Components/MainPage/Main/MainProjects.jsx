        ...
        <div className={s.Projects}>
          ...
          <div className={s.Proj}>
            <div className={s.Text}>
              Это сайт, на котором вы сейчас находитесь.<br /> Использовал: react + node js + nginx.
            </div>
          ...
          <div className={s.Proj1}>
            <div className={s.Text1}>
              Игра кликер, с системой регистрации, входа, и ,соответственно, сохранением игровых данных на сервере. Имеется чат, построенный на защищенных вебсокетах (wss).<br /> Использовал: jQuery + php + mysql.
            </div>
          ...
          <div className={s.Proj}>
            <div className={s.Text}>
              Стандартная игра жизнь, базируется на canvas.<br />Использовал: jQuery.
            </div>
          ...
          <div className={s.Proj1}>
            <div className={s.Text1}>
              Самописный алгоритм нахождения пути от одной точки до другой, на canvas.<br /> Использовал: jQuery.
            </div>
